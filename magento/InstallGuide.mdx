---
title: "SureBright Magento App Installation Guide"
...
<AccordionGroup>
  <Accordion title="Access the Server" icon="sparkles">
  ...
  <Accordion title=" Go to the Magento folder" icon="sparkles">
...
<AccordionGroup>
  <Accordion title=" Login to your Magento Admin Panel" icon="sparkles">
  ...
  <Accordion title=" Navigate to Integrations" icon="sparkles">
...
<AccordionGroup>
  <Accordion title="Add Payment Method" icon="sparkles">
