...
<Note>
  Need more detail? Follow the [Brand-Managed Campaign Guide](/klaviyo-integration/brandManagedCampaignGuide) for step-by-step instructions on flow creation, event parameters, and best practices.
</Note>
