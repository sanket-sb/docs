...
To power these campaigns, SureBright automatically sends enriched customer and order data to your Klaviyo account. This includes:
...
To engage customers with eligible warranty options, you’ll set up a custom flow in Klaviyo triggered by SureBright’s eligibility events. This involves:
